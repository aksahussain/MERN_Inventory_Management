...
const createProduct = async (req, res) => {
    const { name, sku, category, price, supplier, minStockLevel, ecoConfig } = req.body;
...
const updateProduct = async (req, res) => {
    const { name, category, price, minStockLevel, ecoConfig } = req.body;
    ...
    try {
        ...
        if (product) {
            ...
            if (ecoConfig) product.ecoConfig = ecoConfig;
