...
const Signup = () => {
    ...
    return (
        <div className="min-h-screen flex bg-white dark:bg-dark-bg transition-all duration-700 overflow-hidden [&_*]:cursor-none" style={{ cursor: 'none' }}>
            <CustomCursor />
            ...
            {/* Left Side: Interactive Blobs Mascot */}
