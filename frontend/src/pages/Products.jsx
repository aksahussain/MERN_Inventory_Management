...
const Products = () => {
    ...
    const [formData, setFormData] = useState({
        name: '', sku: '', category: '', price: '', minStockLevel: '', ecoConfig: { carbonFootprint: 0, recyclable: false }
    });
    ...
    const handleEdit = (product) => {
        ...
        setFormData({
            ...
            ecoConfig: product.ecoConfig || { carbonFootprint: 0, recyclable: false }
        });
        setIsModalOpen(true);
    };
    ...
    const closeModal = () => {
        ...
        setFormData({ name: '', sku: '', category: '', price: '', minStockLevel: '', ecoConfig: { carbonFootprint: 0, recyclable: false } });
    };
